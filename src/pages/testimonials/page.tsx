  ...
  const testimonials = [
    {
      ...
      image: 'https://readdy.ai/api/search-image?query=Professional%20portrait%20of%20happy%20Australian%20mother%20in%20her%2030s%2C%20warm%20smile%2C%20casual%20modern%20clothing%2C%20natural%20outdoor%20lighting%2C%20clean%20simple%20background%2C%20high%20quality%20professional%20photography&width=150&height=150&seq=testimonial-sarah-premium&orientation=squarish',
    ...
    },
    {
      ...
      image: 'https://readdy.ai/api/search-image?query=Professional%20portrait%20of%20happy%20Australian%20father%20in%20his%2030s%2C%20warm%20smile%2C%20casual%20modern%20clothing%2C%20natural%20outdoor%20lighting%2C%20clean%20simple%20background%2C%20high%20quality%20professional%20photography&width=150&height=150&seq=testimonial-michael-premium&orientation=squarish',
    ...
    },
    {
      ...
      image: 'https://readdy.ai/api/search-image?query=Professional%20portrait%20of%20happy%20Australian%20mother%20in%20her%2030s%2C%20warm%20smile%2C%20casual%20modern%20clothing%2C%20natural%20outdoor%20lighting%2C%20clean%20simple%20background%2C%20high%20quality%20professional%20photography&width=150&height=150&seq=testimonial-emma-premium&orientation=squarish',
    ...
    },
    {
      ...
      image: 'https://readdy.ai/api/search-image?query=Professional%20portrait%20of%20happy%20Australian%20mother%20in%20her%2030s%2C%20warm%20smile%2C%20casual%20modern%20clothing%2C%20natural%20outdoor%20lighting%2C%20clean%20simple%20background%2C%20high%20quality%20professional%20photography&width=150&height=150&seq=testimonial-jessica-premium&orientation=squarish',
    ...
    },
    {
      ...
      image: 'https://readdy.ai/api/search-image?query=Professional%20portrait%20of%20happy%20Australian%20father%20in%20his%2030s%2C%20warm%20smile%2C%20casual%20modern%20clothing%2C%20natural%20outdoor%20lighting%2C%20clean%20simple%20background%2C%20high%20quality%20professional%20photography&width=150&height=150&seq=testimonial-andrew-premium&orientation=squarish',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden" style={{
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(20)].map((_, i) => (
            ...
            >
              <i className="ri-star-fill text-2xl text-[#FFC837]" style={{ filter: 'drop-shadow(0 0 8px rgba(255, 200, 55, 0.6))' }}></i>
            </div>
          ))}
        </div>

        <div className="max-w-[1280px] mx-auto px-6 py-24 relative z-10 text-center">
          <div className="inline-flex items-center gap-3 bg-white px-6 py-4 rounded-full mb-8 border-4 border-[#FF4F87]" style={{
            boxShadow: '0 8px 30px rgba(255, 79, 135, 0.4), inset 0 2px 10px rgba(255, 79, 135, 0.2)'
          }}>
          ...
          <h1 className="text-6xl lg:text-7xl font-extrabold text-[#0A2A66] mb-6 leading-tight" style={{ fontFamily: 'Nunito, sans-serif' }}>
            Parent <span className="bg-gradient-to-r from-[#FF4F87] via-[#FF8A3D] to-[#FFC837] bg-clip-text text-transparent" style={{
        ...
        <div className="max-w-[1280px] mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-6xl font-extrabold text-[#0A2A66] mb-6" style={{ fontFamily: 'Nunito, sans-serif' }}>
              Real <span className="bg-gradient-to-r from-[#4AD36D] to-[#33C8FF] bg-clip-text text-transparent">Impact Stories</span>
            </h2>
          ...
          <div className="space-y-8">
            {impactStories.map((story, index) => (
              <div key={index} className="group">
                <div className={`bg-gradient-to-r ${story.gradient} rounded-[40px] p-12 hover:scale-105 transition-all duration-300 border-6 border-[#0A2A66] cursor-pointer relative overflow-hidden`} style={{
                  ...
                  <div className="flex items-start gap-6">
                    {/* Icon */}
                    <div className="w-24 h-24 flex items-center justify-center rounded-3xl flex-shrink-0" style={{
                      backgroundColor: 'white',
                      boxShadow: `0 10px 30px ${story.color}60, inset 0 2px 10px ${story.color}30`
                    }}>
                      <i className={`${story.icon} text-6xl`} style={{ color: story.color }}></i>
                    </div>

                    {/* Content */}
                    <div className="flex-1">
                      <h3 className="text-3xl font-extrabold text-white mb-4" style={{ fontFamily: 'Nunito, sans-serif', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>{story.title}</h3>
                      <p className="text-white/95 text-lg leading-relaxed">{story.description}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <style>{`
        ...
        @media (max-width: 480px) {
          ...
          .space-y-8 .group .flex.items-start { flex-direction: row !important; align-items: flex-start !important; gap: 1rem !important; }
          .space-y-8 .group .w-24 { width: 84px !important; height: 84px !important; min-width: 84px !important; border-radius: 18px !important; }
          .space-y-8 .group h3 { font-size: 1.8rem !important; line-height: 1.3 !important; margin: 0 0 1rem 0 !important; font-weight: 900 !important; color: #ffffff !important; }
          .space-y-8 .group p { font-size: 1.2rem !important; line-height: 1.7 !important; color: rgba(255,255,255,0.95) !important; }

...
export default function FAQ() {
      ...
      questions: [
        {
          ...
          answer: 'The Early Start Denver Model (ESDM) is a comprehensive, evidence-based early intervention approach designed for young children with autism. It blends developmental and behavioural strategies within natural, play-based routines to support growth across all areas—including communication, social skills, cognition, and motor development.'
        },
        {
          question: 'What age group is ESDM therapy for?',
          answer: 'ESDM is designed for children aged 12-48 months (1-4 years old). Early intervention during these critical developmental years maximizes brain plasticity and leads to significantly better outcomes.'
        },
        {
          question: 'How is ESDM different from other therapies?',
          answer: "ESDM is unique because it combines developmental and behavioral approaches in a naturalistic, play-based format. Unlike traditional table-based therapy, ESDM happens during fun, engaging activities that follow your child's interests, making learning more effective and enjoyable."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'You can book a consultation by emailing us. We’ll schedule a free initial consultation to discuss your child’s needs, answer your questions, and explain how our ESDM therapy can support their development.'
        },
        {
          question: 'What happens during the first session?',
          answer: "The first session is a comprehensive assessment where we evaluate your child's current skills across all developmental areas. We'll also discuss your family's priorities and goals. This helps us create a personalized therapy plan tailored to your child's unique needs."
        },
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "While research indicates that intensive early intervention (8-10 hours per week) yields the best outcomes, we recognize that every family's circumstances are unique. Therefore, we are committed to collaborating with you to develop a schedule that effectively balances clinical effectiveness with your family's specific needs and available resources."
        },
        {
          question: 'Can parents observe therapy sessions?',
          answer: "Absolutely! Parent involvement is a core component of ESDM. We'll teach you strategies to continue your child's learning throughout daily routines at home."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Every child progresses at their own pace. Some families notice improvements within the first few weeks, while others may take a few months. We track progress regularly and adjust goals as needed. Consistency and intensity of therapy significantly impact the speed of progress.'
        },
        {
          question: 'How do you measure progress?',
          answer: "We use standardized ESDM assessment tools to measure progress across all developmental domains. You'll receive regular progress reports showing your child's achievements and updated goals. We also value your observations of changes in daily life."
        },
        {
          question: "What if my child isn't making progress?",
          answer: "If progress plateaus, we'll reassess and adjust the therapy approach. This might include changing strategies, modifying goals, or increasing session intensity. We're committed to finding what works best for your child."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "Therapy costs vary based on session length and location. Contact us for detailed pricing information. We'll work with you to create a plan that fits your budget while maximizing outcomes"
        },
        {
          question: 'Do you accept NDIS funding?',
          answer: "Absolutely! We proudly accept NDIS funding. Our team is here to assist you in understanding how to best utilize your NDIS plan for the services we provide."
        },
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <SEO title="ESDM Therapy FAQ | Early Intervention Questions | Unique Stars Sydney"
      ...
      <section className="relative overflow-hidden" style={{
        ...
        <div className="max-w-[1280px] mx-auto px-6 py-24 relative z-10 text-center">
          <div className="inline-flex items-center gap-3 bg-white px-6 py-4 rounded-full mb-8 border-4 border-[#4AD36D]" style={{
            boxShadow: '0 8px 30px rgba(74, 211, 109, 0.4), inset 0 2px 10px rgba(74, 211, 109, 0.2)'
          }}>
            <div className="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-[#4AD36D] to-[#33C8FF] rounded-full" style={{ boxShadow: '0 4px 15px rgba(74, 211, 109, 0.5)' }}>
          ...
          <h1 className="text-6xl lg:text-7xl font-extrabold text-[#0A2A66] mb-6 leading-tight" style={{ fontFamily: 'Nunito, sans-serif' }}>
            Frequently Asked <span className="bg-gradient-to-r from-[#4AD36D] via-[#33C8FF] to-[#0480E8] bg-clip-text text-transparent" style={{
              filter: 'drop-shadow(0 4px 8px rgba(74, 211, 109, 0.3))'
            }}>Questions</span>
          </h1>
          <p className="text-xl text-[#0A2A66] max-w-3xl mx-auto leading-relaxed">
            Find answers to common questions about our ESDM therapy services, getting started, and what to expect.
          </p>
        </div>
      </section>
          ...
          {faqCategories.map((category, catIndex) => (
            <div key={catIndex} className="mb-16">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-3xl font-extrabold text-[#0A2A66]" style={{ fontFamily: 'Nunito, sans-serif' }}>
                  {category.category}
                </h2>
              </div>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between p-8 gap-6">
                        <div className="flex items-center gap-5 flex-1">
                          ...
                          {/* Question Text */}
                          <h3 className="text-xl font-extrabold text-[#0A2A66] flex-1" style={{ fontFamily: 'Nunito, sans-serif' }}>
                            {item.question}
                          </h3>
                        </div>
                        ...
                        <div
                          ...
                          aria-hidden
                        >
                          <i className="ri-arrow-down-s-line text-3xl" style={{ color: category.color }}></i>
                        </div>
                      </div>
                      ...
                      >
                        <div className="px-8 pb-8 pt-0">
                          ...
                          <p className="text-[#0A2A66] text-lg leading-relaxed pl-[68px]">
                            {item.answer}
                          </p>
                        </div>
                      </div>
      ...
      <section className="py-24 bg-gradient-to-br from-[#0A2A66] via-[#0480E8] to-[#0A2A66] relative overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-6 text-center relative z-10">
          <h2 className="text-5xl lg:text-7xl font-extrabold text-white mb-8" style={{
            ...
            Still Have <span className="bg-gradient-to-r from-[#FFC837] to-[#FFDD55] bg-clip-text text-transparent" style={{
